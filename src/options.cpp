...
static const char *usage_str =
    ...
    " -t, --tty=TTY            Specify file to use as TTY device (default "
    "/dev/tty)\n"
    " -s, --show-scores        Show the scores of each match\n"
    " -j, --workers NUM        Use NUM workers for searching. (default is # of "
    "CPUs)\n"
    " -h, --help     Display this help and exit\n"
    " -v, --version  Output version information and exit\n";

static void usage(const char *argv0) { fprintf(stderr, usage_str, argv0); }
...
void options_parse(options_t *options, int argc, char *argv[]) {
  ...
  int c;
  while ((c = getopt_long(argc, argv, "vhse:q:l:t:p:j:", longopts, NULL)) !=
         -1) {
    switch (c) {
    case 'v':
