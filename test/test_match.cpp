...
TEST score_gaps() {
  ...
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING * 2 + SCORE_GAP_TRAILING,
                  match("a", "**a*"));
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING * 2 + SCORE_GAP_TRAILING * 2,
                  match("a", "**a**"));
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING * 2 + SCORE_MATCH_CONSECUTIVE +
                      SCORE_GAP_TRAILING * 2,
                  match("aa", "**aa**"));
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING + SCORE_GAP_LEADING + SCORE_GAP_INNER +
...
TEST score_consecutive() {
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING + SCORE_MATCH_CONSECUTIVE,
                  match("aa", "*aa"));
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING + SCORE_MATCH_CONSECUTIVE * 2,
                  match("aaa", "*aaa"));
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING + SCORE_GAP_INNER + SCORE_MATCH_CONSECUTIVE,
                  match("aaa", "*a*aa"));
  PASS();
}
...
TEST score_slash() {
  ...
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING * 2 + SCORE_MATCH_SLASH +
...
TEST score_capital() {
  ...
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING * 2 + SCORE_MATCH_CAPITAL,
                  match("a", "baA"));
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING * 2 + SCORE_MATCH_CAPITAL +
                      SCORE_MATCH_CONSECUTIVE,
                  match("aa", "baAa"));
...
TEST score_dot() {
  ...
  ASSERT_SCORE_EQ(SCORE_GAP_LEADING + SCORE_GAP_INNER + SCORE_MATCH_DOT,
                  match("a", "*a.a"));
  PASS();
}
